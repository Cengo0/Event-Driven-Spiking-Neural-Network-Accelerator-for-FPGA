...
Demonstrates how to simulate the SpikeMold fabric Verilog RTL from Python
...
def demo_python_only_simulation():
    ...
    accel = SpikePressAccelerator(simulation_mode=True)
    ...
    print(f"  Note: This is behavioral simulation, not RTL timing evidence")
    print(f"  For RTL timing evidence, use the locked xsim/Vivado flow")
...
def demo_cocotb_setup():
    ...
    try:
        from spikepress.native.rtl_simulator import CocotbSimulator, COCOTB_AVAILABLE
...
def main():
    """Main example runner."""
    print("\n" + "#" * 60)
    print("# SpikeMold RTL Simulation Examples")
    print("#" * 60)
