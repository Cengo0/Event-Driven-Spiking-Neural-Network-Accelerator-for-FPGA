...
DEFAULT_SPIKEMOLD_MINI_LIMITS = EventBudgetLimits(
...
def recommended_spikemold_mini_config() -> Dict[str, object]:
    return {
        "target": "pynq-z2",
        "primitive": "spikemold-mini-fc-lif",
        "state_width_bits": 32,
        "weight_width_bits": 16,
        "ddr_bytes_inner_loop": DEFAULT_SPIKEMOLD_MINI_LIMITS.max_ddr_bytes_inner_loop,
        "python_inner_loop_steps": DEFAULT_SPIKEMOLD_MINI_LIMITS.max_python_inner_loop_steps,
        **asdict(DEFAULT_SPIKEMOLD_MINI_LIMITS),
    }


def evaluate_trace_budget(
    trace: Mapping[str, object],
    limits: EventBudgetLimits = DEFAULT_SPIKEMOLD_MINI_LIMITS,
) -> EventBudgetResult:
...
def summarize_trace_budgets(
    ...
    return {
        ...
        "recommended_spikemold_mini_config": recommended_spikemold_mini_config(),
