...
entity snn_top_hls_weight_memory_RAM_T2P_BRAM_3R2W is
    generic(
        MEM_TYPE        : string    := "block";
        DataWidth       : integer   := 4;
        AddressWidth    : integer   := 17;
        AddressRange    : integer   := 69632
    );
    port (
...
architecture rtl of snn_top_hls_weight_memory_RAM_T2P_BRAM_3R2W is
...
p_IO_pipeline_reg_1 : process (clk)
begin
    if (clk'event and clk = '1') then
        if (ce1 = '1') then
