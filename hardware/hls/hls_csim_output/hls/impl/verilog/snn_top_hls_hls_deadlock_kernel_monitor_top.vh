...
assign axis_block_sigs[4] = ~grp_snn_top_hls_Pipeline_LOAD_FRAME_fu_1074.s_axis_data_TDATA_blk_n;

assign inst_block_sigs[0] = 1'b0;

assign inst_idle_sigs[0] = 1'b0;
assign inst_idle_sigs[1] = grp_snn_top_hls_Pipeline_LOAD_FRAME_fu_1074.ap_idle;
