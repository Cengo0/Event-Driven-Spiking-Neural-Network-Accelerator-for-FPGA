set moduleName process_post_spike_aer
set isTopModule 0
...
set cdfgNum 21
set C_modelName {process_post_spike_aer}
...
dict set ap_memory_interface_dict pre_traces_trace_1 { MEM_WIDTH 8 MEM_SIZE 128 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict pre_traces_last_spike_time_1 { MEM_WIDTH 16 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict pre_traces_trace_0 { MEM_WIDTH 8 MEM_SIZE 128 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict pre_traces_last_spike_time_0 { MEM_WIDTH 16 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
...
set C_modelArgList {
	...
	{ post_traces_trace_0 int 8 regular {array 128 { 1 0 } 1 1 } {global 2}  }
	{ post_traces_trace_1 int 8 regular {array 128 { 1 0 } 1 1 } {global 2}  }
	{ post_traces_last_spike_time_0 int 16 regular {array 128 { 1 0 } 1 1 } {global 2}  }
	{ post_traces_last_spike_time_1 int 16 regular {array 128 { 1 0 } 1 1 } {global 2}  }
	{ EXP_DECAY_LUT int 8 regular {array 16 { 1 } 1 1 } {global 0}  }
	{ pre_traces_trace_1 int 8 regular {array 128 { 1 3 } 1 1 } {global 0}  }
	{ pre_traces_last_spike_time_1 int 16 regular {array 128 { 1 3 } 1 1 } {global 0}  }
	{ pre_traces_trace_0 int 8 regular {array 128 { 1 3 } 1 1 } {global 0}  }
	{ pre_traces_last_spike_time_0 int 16 regular {array 128 { 1 3 } 1 1 } {global 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "post_id", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "post_traces_trace_0", "interface" : "memory", "bitwidth" : 8, "direction" : "READWRITE", "extern" : 0} , 
 	{ "Name" : "post_traces_trace_1", "interface" : "memory", "bitwidth" : 8, "direction" : "READWRITE", "extern" : 0} , 
 	{ "Name" : "post_traces_last_spike_time_0", "interface" : "memory", "bitwidth" : 16, "direction" : "READWRITE", "extern" : 0} , 
 	{ "Name" : "post_traces_last_spike_time_1", "interface" : "memory", "bitwidth" : 16, "direction" : "READWRITE", "extern" : 0} , 
 	{ "Name" : "EXP_DECAY_LUT", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "pre_traces_trace_1", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "pre_traces_last_spike_time_1", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "pre_traces_trace_0", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "pre_traces_last_spike_time_0", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY", "extern" : 0} , 
...
set portList { 
	...
	{ post_traces_trace_0_address0 sc_out sc_lv 7 signal 2 } 
	{ post_traces_trace_0_ce0 sc_out sc_logic 1 signal 2 } 
	{ post_traces_trace_0_q0 sc_in sc_lv 8 signal 2 } 
	...
	{ post_traces_trace_1_address0 sc_out sc_lv 7 signal 3 } 
	{ post_traces_trace_1_ce0 sc_out sc_logic 1 signal 3 } 
	{ post_traces_trace_1_q0 sc_in sc_lv 8 signal 3 } 
	{ post_traces_trace_1_address1 sc_out sc_lv 7 signal 3 } 
	{ post_traces_trace_1_ce1 sc_out sc_logic 1 signal 3 } 
	{ post_traces_trace_1_we1 sc_out sc_logic 1 signal 3 } 
	{ post_traces_trace_1_d1 sc_out sc_lv 8 signal 3 } 
	{ post_traces_last_spike_time_0_address0 sc_out sc_lv 7 signal 4 } 
	{ post_traces_last_spike_time_0_ce0 sc_out sc_logic 1 signal 4 } 
	{ post_traces_last_spike_time_0_q0 sc_in sc_lv 16 signal 4 } 
	{ post_traces_last_spike_time_0_address1 sc_out sc_lv 7 signal 4 } 
	{ post_traces_last_spike_time_0_ce1 sc_out sc_logic 1 signal 4 } 
	{ post_traces_last_spike_time_0_we1 sc_out sc_logic 1 signal 4 } 
	{ post_traces_last_spike_time_0_d1 sc_out sc_lv 16 signal 4 } 
	{ post_traces_last_spike_time_1_address0 sc_out sc_lv 7 signal 5 } 
	{ post_traces_last_spike_time_1_ce0 sc_out sc_logic 1 signal 5 } 
	{ post_traces_last_spike_time_1_q0 sc_in sc_lv 16 signal 5 } 
	{ post_traces_last_spike_time_1_address1 sc_out sc_lv 7 signal 5 } 
	{ post_traces_last_spike_time_1_ce1 sc_out sc_logic 1 signal 5 } 
	{ post_traces_last_spike_time_1_we1 sc_out sc_logic 1 signal 5 } 
	{ post_traces_last_spike_time_1_d1 sc_out sc_lv 16 signal 5 } 
	...
	{ pre_traces_trace_1_address0 sc_out sc_lv 7 signal 7 } 
	{ pre_traces_trace_1_ce0 sc_out sc_logic 1 signal 7 } 
	{ pre_traces_trace_1_q0 sc_in sc_lv 8 signal 7 } 
	{ pre_traces_last_spike_time_1_address0 sc_out sc_lv 7 signal 8 } 
	{ pre_traces_last_spike_time_1_ce0 sc_out sc_logic 1 signal 8 } 
	{ pre_traces_last_spike_time_1_q0 sc_in sc_lv 16 signal 8 } 
	{ pre_traces_trace_0_address0 sc_out sc_lv 7 signal 9 } 
	{ pre_traces_trace_0_ce0 sc_out sc_logic 1 signal 9 } 
	{ pre_traces_trace_0_q0 sc_in sc_lv 8 signal 9 } 
	{ pre_traces_last_spike_time_0_address0 sc_out sc_lv 7 signal 10 } 
	{ pre_traces_last_spike_time_0_ce0 sc_out sc_logic 1 signal 10 } 
	{ pre_traces_last_spike_time_0_q0 sc_in sc_lv 16 signal 10 } 
...
set Spec2ImplPortList { 
	...
	post_traces_trace_0 { ap_memory {  { post_traces_trace_0_address0 mem_address 1 7 }  { post_traces_trace_0_ce0 mem_ce 1 1 }  { post_traces_trace_0_q0 mem_dout 0 8 }  { post_traces_trace_0_address1 MemPortADDR2 1 7 }  { post_traces_trace_0_ce1 MemPortCE2 1 1 }  { post_traces_trace_0_we1 MemPortWE2 1 1 }  { post_traces_trace_0_d1 MemPortDIN2 1 8 } } }
	post_traces_trace_1 { ap_memory {  { post_traces_trace_1_address0 mem_address 1 7 }  { post_traces_trace_1_ce0 mem_ce 1 1 }  { post_traces_trace_1_q0 mem_dout 0 8 }  { post_traces_trace_1_address1 MemPortADDR2 1 7 }  { post_traces_trace_1_ce1 MemPortCE2 1 1 }  { post_traces_trace_1_we1 MemPortWE2 1 1 }  { post_traces_trace_1_d1 MemPortDIN2 1 8 } } }
	post_traces_last_spike_time_0 { ap_memory {  { post_traces_last_spike_time_0_address0 mem_address 1 7 }  { post_traces_last_spike_time_0_ce0 mem_ce 1 1 }  { post_traces_last_spike_time_0_q0 mem_dout 0 16 }  { post_traces_last_spike_time_0_address1 MemPortADDR2 1 7 }  { post_traces_last_spike_time_0_ce1 MemPortCE2 1 1 }  { post_traces_last_spike_time_0_we1 MemPortWE2 1 1 }  { post_traces_last_spike_time_0_d1 MemPortDIN2 1 16 } } }
	post_traces_last_spike_time_1 { ap_memory {  { post_traces_last_spike_time_1_address0 mem_address 1 7 }  { post_traces_last_spike_time_1_ce0 mem_ce 1 1 }  { post_traces_last_spike_time_1_q0 mem_dout 0 16 }  { post_traces_last_spike_time_1_address1 MemPortADDR2 1 7 }  { post_traces_last_spike_time_1_ce1 MemPortCE2 1 1 }  { post_traces_last_spike_time_1_we1 MemPortWE2 1 1 }  { post_traces_last_spike_time_1_d1 MemPortDIN2 1 16 } } }
	...
	pre_traces_trace_1 { ap_memory {  { pre_traces_trace_1_address0 mem_address 1 7 }  { pre_traces_trace_1_ce0 mem_ce 1 1 }  { pre_traces_trace_1_q0 mem_dout 0 8 } } }
	pre_traces_last_spike_time_1 { ap_memory {  { pre_traces_last_spike_time_1_address0 mem_address 1 7 }  { pre_traces_last_spike_time_1_ce0 mem_ce 1 1 }  { pre_traces_last_spike_time_1_q0 mem_dout 0 16 } } }
	pre_traces_trace_0 { ap_memory {  { pre_traces_trace_0_address0 mem_address 1 7 }  { pre_traces_trace_0_ce0 mem_ce 1 1 }  { pre_traces_trace_0_q0 mem_dout 0 8 } } }
	pre_traces_last_spike_time_0 { ap_memory {  { pre_traces_last_spike_time_0_address0 mem_address 1 7 }  { pre_traces_last_spike_time_0_ce0 mem_ce 1 1 }  { pre_traces_last_spike_time_0_q0 mem_dout 0 16 } } }
