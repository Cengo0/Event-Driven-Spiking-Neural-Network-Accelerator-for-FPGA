...
void XSnn_top_hls_Set_encoder_config(XSnn_top_hls *InstancePtr, XSnn_top_hls_Encoder_config Data) {
    ...
    XSnn_top_hls_WriteReg(InstancePtr->Ctrl_BaseAddress, XSNN_TOP_HLS_CTRL_ADDR_ENCODER_CONFIG_DATA + 12, Data.word_3);
    XSnn_top_hls_WriteReg(InstancePtr->Ctrl_BaseAddress, XSNN_TOP_HLS_CTRL_ADDR_ENCODER_CONFIG_DATA + 16, Data.word_4);
}
...
XSnn_top_hls_Encoder_config XSnn_top_hls_Get_encoder_config(XSnn_top_hls *InstancePtr) {
    ...
    Data.word_3 = XSnn_top_hls_ReadReg(InstancePtr->Ctrl_BaseAddress, XSNN_TOP_HLS_CTRL_ADDR_ENCODER_CONFIG_DATA + 12);
    Data.word_4 = XSnn_top_hls_ReadReg(InstancePtr->Ctrl_BaseAddress, XSNN_TOP_HLS_CTRL_ADDR_ENCODER_CONFIG_DATA + 16);
    return Data;
}
