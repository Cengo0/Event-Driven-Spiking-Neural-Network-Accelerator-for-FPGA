...
set name snn_top_hls_mul_8s_8s_16_1_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler snn_top_hls_sparsemux_9_3_7_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {onehotencoding_realdef}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_shift_sel \
    op interface \
    ports { shift_sel { I 2 vector } } \
} "
}
