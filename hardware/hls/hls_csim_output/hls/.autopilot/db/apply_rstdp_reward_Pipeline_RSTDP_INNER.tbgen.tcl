set moduleName apply_rstdp_reward_Pipeline_RSTDP_INNER
set isTopModule 0
...
set cdfgNum 21
set C_modelName {apply_rstdp_reward_Pipeline_RSTDP_INNER}
...
set C_modelArgList {
	{ i int 8 regular  }
	{ sext_ln486 int 8 regular  }
	{ shift_sel int 2 regular  }
	{ empty int 1 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "i", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln486", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "shift_sel", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln486 sc_in sc_lv 8 signal 1 } 
	{ shift_sel sc_in sc_lv 2 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln486", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "sext_ln486", "role": "default" }} , 
 	{ "name": "shift_sel", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "shift_sel", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln486 { ap_none {  { sext_ln486 in_data 0 8 } } }
	shift_sel { ap_none {  { shift_sel in_data 0 2 } } }
