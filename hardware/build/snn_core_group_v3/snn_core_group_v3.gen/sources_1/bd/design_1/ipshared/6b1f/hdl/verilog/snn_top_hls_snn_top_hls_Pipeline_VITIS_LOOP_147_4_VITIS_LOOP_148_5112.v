...
wire    ap_loop_init;
reg   [2:0] dy2_fu_82;
wire   [2:0] select_ln147_153_fu_205_p3;
reg   [3:0] indvar_flatten797_fu_86;
...
wire   [2:0] select_ln147_152_fu_237_p3;
wire   [1:0] trunc_ln153_fu_278_p1;
wire   [3:0] tmp_112_fu_282_p3;
...
#0 dx2_fu_78 = 3'd0;
#0 dy2_fu_82 = 3'd0;
#0 indvar_flatten797_fu_86 = 4'd0;
#0 ap_done_reg = 1'b0;
end
...
assign add_ln147_fu_162_p2 = (ap_sig_allocacmp_indvar_flatten797_load + 4'd1);
...
assign and_ln151_fu_334_p2 = (icmp_ln151_fu_300_p2 & icmp_ln151_83_fu_328_p2);
...
assign icmp_ln147_fu_156_p2 = ((ap_sig_allocacmp_indvar_flatten797_load == 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln148_fu_179_p2 = ((dx2_fu_78 == 3'd2) ? 1'b1 : 1'b0);

assign icmp_ln151_83_fu_328_p2 = ((trunc_ln150_s_fu_314_p4 < 4'd7) ? 1'b1 : 1'b0);
