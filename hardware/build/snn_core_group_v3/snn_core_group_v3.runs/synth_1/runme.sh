...
HD_PWD='/home/chipwisperer/Documents/SNN/Event-Driven-Spiking-Neural-Network-Accelerator-for-FPGA/hardware/build/snn_core_group_v3/snn_core_group_v3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log snn_core_group_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source snn_core_group_top.tcl
