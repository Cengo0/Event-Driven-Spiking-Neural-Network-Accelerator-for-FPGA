...
HD_PWD='/home/chipwisperer/Documents/SNN/Event-Driven-Spiking-Neural-Network-Accelerator-for-FPGA/hardware/build/snn_integrated_v2/snn_integrated_v2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log snn_integrated_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source snn_integrated_top.tcl
