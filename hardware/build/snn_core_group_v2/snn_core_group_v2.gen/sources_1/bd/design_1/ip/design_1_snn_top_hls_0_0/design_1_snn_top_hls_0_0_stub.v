...
// Date        : Sun Sep 20 03:13:57 2026
// Host        : Mariana running 64-bit Ubuntu 22.04.5 LTS
// Command     : write_verilog -force -mode synth_stub
//               /home/chipwisperer/Documents/SNN/Event-Driven-Spiking-Neural-Network-Accelerator-for-FPGA/hardware/build/snn_core_group_v2/snn_core_group_v2.gen/sources_1/bd/design_1/ip/design_1_snn_top_hls_0_0/design_1_snn_top_hls_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "design_1_snn_top_hls_0_0,snn_top_hls,{}" *) (* CORE_GENERATION_INFO = "design_1_snn_top_hls_0_0,snn_top_hls,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=snn_top_hls,x_ipVersion=1.0,x_ipCoreRevision=2114793565,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_S_AXI_CTRL_ADDR_WIDTH=8,C_S_AXI_CTRL_DATA_WIDTH=32}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
...
/* synthesis syn_force_seq_prim="ap_clk" */;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 spike_in_neuron_id DATA" *) (* X_INTERFACE_MODE = "master" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME spike_in_neuron_id, LAYERED_METADATA undef" *) output [9:0]spike_in_neuron_id;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 spike_out_neuron_id DATA" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME spike_out_neuron_id, LAYERED_METADATA undef" *) input [9:0]spike_out_neuron_id;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 learn_weight_group DATA" *) (* X_INTERFACE_MODE = "master" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME learn_weight_group, LAYERED_METADATA undef" *) output [1:0]learn_weight_group;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 learn_weight_src DATA" *) (* X_INTERFACE_MODE = "master" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME learn_weight_src, LAYERED_METADATA undef" *) output [7:0]learn_weight_src;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 learn_weight_dst DATA" *) (* X_INTERFACE_MODE = "master" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME learn_weight_dst, LAYERED_METADATA undef" *) output [7:0]learn_weight_dst;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 learn_weight_dst_group DATA" *) (* X_INTERFACE_MODE = "master" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME learn_weight_dst_group, LAYERED_METADATA undef" *) output [1:0]learn_weight_dst_group;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 learn_weight_fanout_idx DATA" *) (* X_INTERFACE_MODE = "master" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME learn_weight_fanout_idx, LAYERED_METADATA undef" *) output [7:0]learn_weight_fanout_idx;
