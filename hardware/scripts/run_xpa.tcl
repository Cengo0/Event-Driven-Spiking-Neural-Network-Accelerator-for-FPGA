...
# Testbench path: tb_snn_power_sweep/router_inst -> Cell: u_spike_router
# Testbench path: tb_snn_power_sweep/neuron_array_inst -> Cell: u_neuron_array

read_saif -strip_path tb_snn_power_sweep -out_file "${out_dir}/saif_match.txt" $saif
