...
This review checks the current SpikePress + SpikeMold-EDNP v3.6 board-free
implementation slice:

- Batch 0 contract freeze
- Batch 1A SpikePress software foundation and architecture-neutral traces
- Batch 1B transport and EDNP-mini software smoke artifacts
...
| event budget passes | PASS | `outputs/event_budget/recommended_ednp_mini_config.json` |
...
| EDNP-mini trace/readout/state match | PASS | `outputs/transport/batch_1b_transport_ednp_mini_smoke.json` |
