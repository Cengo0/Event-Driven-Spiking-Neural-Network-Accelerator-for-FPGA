...
|---|---|---|---:|
| A flat FC-LIF event pipeline | flat event/update/state/readout | Batch 1B software transport smoke | PASS |
...
|---|---:|---:|---:|---:|---|
| SpikeMold flat FC-LIF | 3 | 5 | 2 | 1 | `outputs/transport/batch_1b_transport_flat_fc_lif_smoke.json` |
...
|---|---:|---:|---:|---:|
| A flat FC-LIF event pipeline | 1.0 | true | true | PASS |
...
|---|---:|---:|---:|---:|---:|---:|
| A flat FC-LIF event pipeline | < 1000 | < 1000 | 1-2 BRAM | 0 | <= 512 B | 125 MHz target, not routed |
...
Cycle estimates are board-free. `cycle_count` for the flat FC-LIF path is from the
...
|---|---:|---:|---:|---:|---:|
| A flat FC-LIF event pipeline | 8 model cycles / 3 inputs | 8 model cycles / 5 updates | 8 model cycles / 1 output | 1024 by current budget | 0 in smoke |
...
|---|---:|---:|---:|---:|---:|
| A flat FC-LIF event pipeline | 5 | 6 | 0 inner-loop | 0 inner-loop | small local state/FIFO |
...
| Field | A flat FC-LIF event pipeline | D shared-kernel EventConv AGU C4 |
|---|---:|---:|
...
| event/update histogram | `outputs/event_budget/recommended_flat_fc_lif_config.json` | `outputs/event_budget/recommended_flat_fc_lif_config.json` |
...
|---|---:|---:|---:|---|
| A flat FC-LIF event pipeline | 2 in smoke | 8 in smoke | 0 inner-loop | board runtime still needed |
...
- A flat FC-LIF path for small FC/readout workloads
